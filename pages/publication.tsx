    ...
    <div className="">
      ...
      <div className="flex flex-col min-h-screen dark:bg-dark-900">
        ...
        <main className="container flex flex-col mx-auto flex-1 max-w-3xl px-6">
          <h1 className="font-serif text-4xl mb-8 heading-text">Publication</h1>
          ...
          >
            <div className="flex flex-wrap font-mono text-xs mb-1 gap-1 uppercase">
              <span className="rounded-full bg-green-200 px-2 dark:bg-green-700 dark:text-white">IJCAI 2021</span>
              <span className="rounded-full bg-red-200 px-2 dark:bg-red-700 dark:text-white">Adversarial Attack</span>
              <span className="rounded-full bg-blue-200 px-2 dark:bg-blue-700 dark:text-white">
                Perceptual Similarity
              </span>
            </div>
            <h2 className="font-bold font-serif primary-text">
