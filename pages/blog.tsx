    ...
    <>
      ...
      <div className="flex flex-col min-h-screen dark:bg-dark-900">
        ...
        <main className="container flex flex-col mx-auto flex-1 max-w-3xl px-6">
          <h1 className="font-serif text-4xl mb-8 heading-text">Blog</h1>
          ...
          {posts.map((post: any) => (
            <div key={post.id}>
              <Link href={`/blog/${post.properties.slug.rich_text[0].text.content}`} passHref>
                <a className="border-none rounded cursor-pointer -mx-2 mb-6 p-2 hover:bg-light-200 hover:opacity-80 dark:hover:bg-dark-700">
